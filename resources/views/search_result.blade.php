        ...
        <div class="e-panel card">
          <div class="card-body">
            ...
            <div class="card-title " style="overflow: hidden;">
              <span class="mr-2  float-left" style="font-size:20px;"><span></span><small class="px-1">Search Result</small></span>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-nowrap align-middle"><span>
                        {{ \Carbon\Carbon::parse($row->created_at)->format('M D Y / h:i:s A')}}
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="e-navlist e-navlist--active-bold">
              <ul class="nav">
                <li class="nav-item active"><a href="{{route('user_list')}}" class="nav-link"><span>All</span>&nbsp;</a></li>
                <li class="nav-item"><a href="{{route('active_list')}}" class="nav-link"><span>Active</span>&nbsp;</a></li>
              </ul>
            </div>
            <hr class="my-3">
            ...
            <div>
              <div class="form-group">
                ...
                <div>
                  <input id="dates-range" name="dateTo" class="form-control flatpickr-input" placeholder="Last 3 Monthe" type="text" readonly="readonly">
                </div>
              </div>
              <div class="form-group">
                <label>Search by Name:</label>
                <div><input class="form-control w-100" name="name" type="text" placeholder="Name" value=""></div>
              </div>
            </div>
            <hr class="my-3">
            <div class="">
              ...
              <div class="px-2">
                <div class="custom-control custom-radio">
                  <input type="radio" class="custom-control-input" name="user_status" value="1" id="users-status-active">
                  <label class="custom-control-label" for="users-status-active">Active</label>
                </div>
              </div>
              <div class="px-2">
                <div class="custom-control custom-radio">
                  <input type="radio" class="custom-control-input" name="user_status" id="users-status-any" value="0" checked="">
